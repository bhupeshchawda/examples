...
public class Application implements StreamingApplication
{
  ...
  public void populateDAG(DAG dag, Configuration conf)
  {
    ...
    DeduperTimeBasedPOJOImpl dedup = dag.addOperator("Deduper", new DeduperTimeBasedPOJOImpl());
    ...
    // Add 2 partitions for Dedup operator
    dag.setAttribute(dedup, Context.OperatorContext.PARTITIONER, new StatelessPartitioner<DeduperTimeBasedPOJOImpl>(2));
  }
